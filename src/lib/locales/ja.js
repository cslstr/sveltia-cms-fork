...
export const strings = {
  ...
  x_entries_displayed: '{count} 個のエントリーを表示',
  x_assets_displayed: '{count} 個のアセットを表示',
  x_entries_matching_filter: '{count} 個のエントリーがフィルターに一致',
  x_assets_matching_filter: '{count} 個のアセットがフィルターに一致',
  x_entries_matching_filter_named: '{count} 個のエントリー「{filter}」',
  x_assets_matching_filter_named: '{count} 個の「{filter}」タイプのアセット',
  x_entries_matching_filters_named: '{count} 個のエントリー {filters}',
  x_assets_matching_filters_named: '{count} 個の {filters} タイプのアセット',
  and_separator: ' と ',
