...
export const strings = {
  ...
  x_entries_displayed: '{count} entries displayed',
  x_assets_displayed: '{count} assets displayed',
  x_entries_matching_filter: '{count} entries matching filter',
  x_assets_matching_filter: '{count} assets matching filter',
  x_entries_matching_filter_named: '{count} entries "{filter}"',
  x_assets_matching_filter_named: '{count} assets of type "{filter}"',
  x_entries_matching_filters_named: '{count} entries {filters}',
  x_assets_matching_filters_named: '{count} assets of type {filters}',
  and_separator: ' and ',
